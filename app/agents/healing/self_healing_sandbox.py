...
class SelfHealingSandbox:
    ...
    def __init__(
        self,
        *,
        patch_adapter: SelfHealingPatchAdapter | None = None,
        patch_applier: SelfHealingPatchApplier | None = None,
    ) -> None:
        """
    ...
    def apply_patch_in_memory(
        ...
        *,
        ...
        try:
            ...
            self.logger.error(f"[Sandbox] Failed to apply diff in memory: {e}", exc_info=True)
    ...
    def record_selector_result(
        ...
        *,
        ...
        page_type: str | None = None,  # 後方互換性のため保持
        selector_result: dict[str, Any] | None = None,  # 後方互換性のため保持
    ) -> None:
        """
