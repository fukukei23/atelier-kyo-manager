...
class ProductInfo:
    ...
    title: str | None = None
    price: float | None = None  # Task 2: float に変更
    ...
    url: str | None = None
    brand: str | None = None
    list_price: float | None = None  # Task 2: float に変更
...
class ProductExtractor:
    ...
    def _get_pdp_config(self) -> dict[str, Any]:
        ...
        self._pdp_config = {
            ...
            "images": self._normalize_images_config(pdp_cfg.get("images"))
            or [
                ".product-images img",
                ".product-gallery img",
            ...
            "availability_patterns": self._get_availability_patterns(
    ...
    def _normalize_images_config(self, images_cfg: Any) -> list[str] | None:
        """
    ...
    def _get_image_attr(self, images_cfg: Any) -> str | None:
        """images 設定から image_attr を取得"""
        if isinstance(images_cfg, dict):
            return images_cfg.get("image_attr")
        return None

    def _get_image_base_url(self, images_cfg: Any) -> str | None:
        """images 設定から image_base_url を取得"""
        if isinstance(images_cfg, dict):
            return images_cfg.get("base_url")
        return None

    def _normalize_availability_config(self, availability_cfg: Any) -> list[str] | None:
        """
    ...
    def _get_availability_patterns(self, availability_cfg: Any, availability_patterns: Any) -> list[str] | None:
        """
    ...
    def _normalize_price(self, price_text: str, price_rules: dict[str, Any]) -> str | None:
    ...
    def _normalize_price_to_float(self, price_text: str, price_rules: dict[str, Any]) -> float | None:
        """
