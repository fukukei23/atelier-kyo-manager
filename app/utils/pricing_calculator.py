...
def calculate_profit(
    ...
    return {"profit_estimate": round(profit_estimate, 2), "profit_rate": round(profit_rate, 2)}
...
if __name__ == "__main__":
    ...
    # 例2: 利益が出ないケース
    result_low = calculate_profit(buyma_price=15000, source_price=120, shipping_cost=20, source_currency="USD")
