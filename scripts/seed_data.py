...
PRODUCTS_DATA = [
    dict(
        ...
        supplier_url="https://example.com/chanel-001",
        color="Black",
        size="M",
        material="Lambskin",
    ...
    dict(
        ...
        selling_price=1105000,
        supplier_url="https://example.com/hermes-001",
        color="Gold",
        size="25cm",
    ...
    dict(
        ...
        selling_price=182000,
        supplier_url="https://example.com/lv-001",
        color="Damier Azur",
        size="MM",
        material="Canvas",
        source_type="overseas",
    ...
    dict(
        ...
        selling_price=234000,
        supplier_url="https://example.com/gucci-001",
        color="Gold",
        size="Small",
        material="Leather",
        source_type="overseas",
    ...
    dict(
        ...
        selling_price=123500,
        supplier_url="https://example.com/prada-001",
        color="Black",
        size="One Size",
        material="Saffiano",
        source_type="overseas",
    ...
    dict(
        name="Nylon Logo Jacket",
        brand="Moncler",
        purchase_price=120000,
        selling_price=156000,
        supplier_url="https://example.com/moncler-001",
        color="Navy",
        size="M",
        material="Nylon",
        source_type="overseas",
    ...
    dict(
        ...
        selling_price=32500,
        supplier_url="https://example.com/nike-001",
        color="Chicago",
        size="27cm",
        material="Leather",
        source_type="overseas",
    ...
    dict(
        ...
        purchase_price=2500,
        selling_price=3250,
        supplier_url="https://example.com/zara-001",
        color="White",
        size="M",
        material="Cotton",
    ...
    dict(
        name="Heattech Ultra Warm",
        brand="UNIQLO",
        purchase_price=1500,
        selling_price=1950,
        supplier_url="https://example.com/uniqlo-001",
        color="Black",
        size="L",
        material="Polyester",
        source_type="domestic",
    ...
    dict(
        ...
        purchase_price=4500,
        selling_price=5850,
        supplier_url="https://example.com/hm-001",
        color="Gray",
        size="M",
        material="Cotton",
        source_type="domestic",
...
def seed_partners() -> list[Partner]:
    ...
    data = [
        dict(
            ...
            active_regions="US,CA",
            specialty_brands="Chanel,Louis Vuitton,Gucci",
            priority_level="high",
            status="active",
        ),
        dict(
            name="Euro Luxe Partners",
            email="info@euroluxe.eu",
            phone="+39-02-555-0200",
            active_regions="IT,FR,DE,UK",
            specialty_brands="Hermes,Prada,Moncler",
            priority_level="medium",
            status="active",
        ),
        dict(
            name="Tokyo Connect",
            email="sales@tokyoconnect.jp",
            phone="03-5555-0300",
            active_regions="JP",
            specialty_brands="UNIQLO,ZARA",
            priority_level="low",
            status="active",
        ),
    ]
...
def seed_orders(products: list[Product], partners: list[Partner]) -> None:
    ...
    orders = [
        Order(
            order_number="BY-2026-0001",
            product_name="Classic Flap Bag",
            customer_name="田中太郎",
        ...
        Order(
            order_number="BY-2026-0002",
            product_name="GG Marmont Small",
            customer_name="佐藤花子",
        ...
        Order(
            order_number="BY-2026-0005",
            product_name="Re-Edition 2005",
            customer_name="伊藤健太",
    ...
    if not RepeatCustomer.query.first():
        customers = [
            RepeatCustomer(
                ...
                total_orders=5,
                total_spent=1750000,
                first_order_date=today - timedelta(days=180),
            ...
            RepeatCustomer(
                ...
                total_orders=12,
                total_spent=4200000,
                first_order_date=today - timedelta(days=365),
                last_order_date=today - timedelta(days=12),
            ),
            RepeatCustomer(
                customer_name="鈴木一郎",
                ...
                total_orders=2,
                total_spent=65000,
                first_order_date=today - timedelta(days=25),
                last_order_date=today - timedelta(days=20),
            ),
        ]
        for c in customers:
            c.update_avg()
    ...
    if not StockCheck.query.first():
        db.session.add_all(
            [
                StockCheck(
                    product_id=products[0].id,
                    source_url="https://example.com/chanel-001",
                ...
                StockCheck(
                    product_id=products[1].id,
                    source_url="https://example.com/hermes-001",
                    current_price=850000,
                    previous_price=850000,
                    in_stock=True,
                    price_changed=False,
                    checked_at=today - timedelta(hours=4),
                ),
                StockCheck(
                    product_id=products[6].id,
                    source_url="https://example.com/nike-001",
                    current_price=28000,
                    previous_price=25000,
                    in_stock=False,
                    price_changed=True,
                    stock_changed=True,
                    checked_at=today - timedelta(hours=6),
                ),
            ]
        )
        print("  StockCheck: 3件")
    ...
    if not RegionRecommendation.query.first():
        for code, name, profit, ship, customs, risk, rel in [
            ...
            rr = RegionRecommendation(
                region=code,
                region_name=name,
                avg_profit_rate=profit,
                avg_shipping_days=ship,
                avg_customs_rate=customs,
                risk_score=risk,
