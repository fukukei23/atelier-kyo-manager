...
def mock_page():
    ...
    def locator_side_effect(selector):
        ...
        if (
            "product-tile" in selector_lower
            or "product-card" in selector_lower
            or "tile" in selector_lower
            or "card" in selector_lower
            or ".product-tile" in selector
        ...
        if (
            "href" in selector_lower
            or "link" in selector_lower
            or "product-link" in selector_lower
            or "a[" in selector_lower
        ):
...
@pytest.mark.asyncio
async def test_browser_use_agent_delegates_to_plp_driver(mock_page, mock_context, site_config, run_context):
    """
...
@pytest.mark.asyncio
async def test_browser_use_agent_uses_plp_driver_result(mock_page, mock_context, site_config, run_context):
    """
...
@pytest.mark.asyncio
async def test_run_plp_flow_saves_plp_navigation_result(mock_page, mock_context, site_config, run_context):
    """
