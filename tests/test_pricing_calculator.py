...
class TestCalculateProfit:
    ...
    def test_normal_profit(self, mock_rate):
        ...
        result = calculate_profit(
            buyma_price=30000, source_price=100, shipping_cost=50, customs_duty_rate=0.1, source_currency="USD"
        )
    ...
    def test_zero_buyma_price(self, mock_rate):
        mock_rate.return_value = 150.0
        result = calculate_profit(buyma_price=0, source_price=100, shipping_cost=10, source_currency="USD")
        assert result["profit_estimate"] < 0
    ...
    def test_negative_profit(self, mock_rate):
        mock_rate.return_value = 150.0
        result = calculate_profit(buyma_price=15000, source_price=120, shipping_cost=20, source_currency="USD")
        assert result["profit_estimate"] < 0
        assert result["profit_rate"] < 0
    ...
    def test_zero_customs_duty(self, mock_rate):
        ...
        result = calculate_profit(
            buyma_price=10000, source_price=30, shipping_cost=10, customs_duty_rate=0.0, source_currency="USD"
        )
    ...
    def test_high_customs_duty(self, mock_rate):
        mock_rate.return_value = 100.0
        result = calculate_profit(
            buyma_price=10000, source_price=30, shipping_cost=10, customs_duty_rate=0.3, source_currency="USD"
        )
    ...
    def test_default_rate_fallback(self, mock_rate):
        ...
        result = calculate_profit(buyma_price=26800, source_price=120, shipping_cost=20, source_currency="USD")
