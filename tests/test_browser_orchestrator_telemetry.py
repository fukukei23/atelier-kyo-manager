...
async def test_run_plp_to_pdp_records_plp_initial_state(
    ...
    with patch("app.agents.browser_orchestrator.TelemetryClient") as mock_telemetry_class, \
         patch("app.agents.browser_orchestrator.NavigationDriver") as mock_nav_driver_class:
...
async def test_run_pdp_records_pdp_dom(
    ...
    with patch("app.agents.browser_orchestrator.TelemetryClient") as mock_telemetry_class, \
         patch("app.agents.browser_orchestrator.BrowserExtractionService") as mock_extraction_service_class:
